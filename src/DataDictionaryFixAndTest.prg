        ...
        if !(alltrim(ListOfColumns->Column_Type) == l_cColumnType) .or. ;
           ...
           !hb_isNil((ListOfColumns->Column_DefaultCustom))
            ...
            with object l_oDB_Record
                ...
                :Field("Column.LastNativeTypeMySQL"      , NULL)
                :Field("Column.LastNativeTypePostgreSQL" , NULL)
                :Field("Column.LastNativeTypeMSSQL"      , NULL)
                :Field("Column.LastNativeTypeOracle"     , NULL)
