...
l_cHtml += [{]
    ...
    l_cHtml += [   $(".SearchMode1").show();$(".SearchMode2").removeClass("d-none").show();$(".SearchMode3").removeClass("d-none").show();]
        ...
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchColumnDocStatus();]
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchColumnTypes();]
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchExtraFilters();]
    l_cHtml += [   break;]
    l_cHtml += [default:]
    l_cHtml += [   console.log(`Sorry, we are out of ${expr}.`);]
    l_cHtml += [};$('.wf-grid').floatThead('reflow');return true;]
l_cHtml += [}]
...
l_cHtml += [{]
    ...
    l_cHtml += [case 3:]
    l_cHtml += [   $(".SearchMode1").show();$(".SearchMode2").removeClass("d-none").show();$(".SearchMode3").removeClass("d-none").show();]
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchEnumerationUsageStatus();]
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchEnumerationDocStatus();]
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchEnumerationImplementAs();]
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchEnumValueUsageStatus();]
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchEnumValueDocStatus();]
        l_cHtml +=     [RefreshGetMultiFlagSearchInput_TextSearchExtraFilters();]
    l_cHtml += [   break;]
    l_cHtml += [default:]
    l_cHtml += [   console.log(`Sorry, we are out of ${expr}.`);]
