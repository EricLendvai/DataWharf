...
function Config()
return ;
{"HarbourORMVersion"=>4.14,;
 "DataWharfVersion"=>4.21,;
 "Backend"=>"PostgreSQL",;
 "GenerationTime"=>"2024-09-21T13:37:13.478Z",;
 "GenerationSignature"=>"63099d38-3b91-4b5a-bb26-dc53e73dfd72",;
 "Rename"=>{;
    "Column"=>{;
        "public"=>{;
            "APIToken"=>{;
 ...
 "Tables"=>;
    ...
    ,"public.Column"=>{"Fields"=>;
        ...
        ,"UID"                     =>{"Type"=>"C","Length"=>36};   //Used to create direct link, if the name is not URL friendly, Is a UUID generated by calling Postgresql "select gen_random_uuid()".
