...
function Config()
return ;
{"HarbourORMVersion"=>4.9,;
 "DataWharfVersion"=>4.10,;
 "Backend"=>"PostgreSQL",;
 "GenerationTime"=>"2024-05-30T08:03:23.609Z",;
 "GenerationSignature"=>"23e63f5a-66d8-4ab5-9563-bc1ceddbe53e",;
 "Rename"=>{;
    "Column"=>{;
        "public"=>{;
            "Application"=>{;
 ...
 "Tables"=>;
    ...
    ,"public.Application"=>{"Fields"=>;
        ...
        ,"SupportColumnsDateTimeConfig"                         =>{"Type"=>"N","Length"=>1,"Default"=>"1","OnDelete"=>"Protect"};   //1="No Change", 2="Without Time Zone", 3="With Time Zone"   
...
"Enumerations"=>;
    ...
    ,"public.SupportColumnsDateTimeConfig"=>{;
        ...
        "ImplementLength"=>1,;
        "Values"=>;
            {"No Change"        =>{"Order"=>1,"Number"=>1};
            ,"Without Time Zone"=>{"Order"=>2,"Number"=>2};
            ,"With Time Zone"   =>{"Order"=>3,"Number"=>3}}};
    ,"public.TagUseStatus"=>{;
        "ImplementAs"=>"Numeric",;
        "ImplementLength"=>1,;
        "Values"=>;
