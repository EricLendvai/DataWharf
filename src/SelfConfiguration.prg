...
function Config()
return ;
{"HarbourORMVersion"=>4.15,;
 "DataWharfVersion"=>4.23,;
 "Backend"=>"PostgreSQL",;
 "GenerationTime"=>"2024-10-24T06:06:22.871Z",;
 "GenerationSignature"=>"fb6b8008-d988-4d6e-b96f-f5852956b2df",;
 "Rename"=>{;
    "Column"=>{;
        "public"=>{;
            "APIToken"=>{;
 ...
 "Tables"=>;
    {"public.APIAccessEndpoint"=>{"Fields"=>;
        ...
        ,"sysc"          =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"sysm"          =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
    ...
    ,"public.APIToken"=>{"Fields"=>;
        ...
        ,"sysc"       =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"sysm"       =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"UID"        =>{"Type"=>"C","Length"=>36};   //Used by UI to edit APIToken. Is a UUID generated by calling postgresql "select gen_random_uuid()".
    ...
    ,"public.Application"=>{"Fields"=>;
        ...
        ,"SupportColumnsDateTimeConfig"                         =>{"Type"=>"N","Length"=>1,"Default"=>"1"};   //1="NoChange", 2="WithoutTimeZone", 3="WithTimeZone"   
        ...
        ,"SetMissingOnDeleteToProtect"                          =>{"Type"=>"L","Default"=>"Wharf-False"};
        ,"NoNamespaceChangeOnTablesAndEnumerations"             =>{"Type"=>"L","Default"=>"Wharf-True"};   //Prevent Changing Namespace on Existing Tables and Enumeration. Changing the Namespace would cause new Tables and Enumerations to be created.
        ,"PreventLoadFromDeployments"                           =>{"Type"=>"L","Default"=>"Wharf-True"};   //If the "Load" option can be used to update database from deployments.
        ...
        ,"TestEnumerationHasAtLeastOnePresentValue"             =>{"Type"=>"L","Default"=>"Wharf-True"};   //Test Enumerations must have at least one present value (present means not Discontinued)
        ,"TestEnumerationValueNumberUniqueness"                 =>{"Type"=>"L","Default"=>"Wharf-True"};
        ...
        ,"TestValidColumnLengthAndScale"                        =>{"Type"=>"L","Default"=>"Wharf-True"};   //Check validity of columns Length and/or Scale base on column type.
        ,"TestNoLeadingOrTrainingBlanksInIdentifiers"           =>{"Type"=>"L","Default"=>"Wharf-True"};   //Check Validity of Namespace, Table, Column, Index and Enumeration Identifiers to Match Variable Name Requirements
        ,"TestValidNonEnumValueIdentifierAsVariableName"        =>{"Type"=>"L","Default"=>"Wharf-True"};   //Check Validity of Namespace, Table, Column, Index and Enumeration Identifiers to Match Variable Name Requirements
        ,"TestValidSQLEnumValueIdentifierAsVariableName"        =>{"Type"=>"L","Default"=>"Wharf-True"};   //Check Validity of Enumeration values used as SQLEnum Identifiers to Match Variable Name Requirements
        ,"TestValidSQLEnumValueIdentifierAsAlphaNumericExtended"=>{"Type"=>"L","Default"=>"Wharf-True"};   //Check Validity of Enumeration values not used as SQLEnum Identifiers to be Alpha Numeric, blank, dash or underscore
        ,"TestIndexOnPrimaryAndForeignKeys"                     =>{"Type"=>"L","Default"=>"Wharf-True"};   //Check Existance of Indexes on Primary and Foreign Keys. Primary and Foreign key indexes are already implicit.
        ,"TestUniquenessCaseInsensitiveIdentifiers"             =>{"Type"=>"L","Default"=>"Wharf-True"};   //Check uniqueness of case insensitive identifiers
        ,"TestUniquenessTableSQLEnumerationIdentifiers"         =>{"Type"=>"L","Default"=>"Wharf-True"}};   //Check uniqueness between Table and SQLEnum Enumeration names in same Namespace
                           ,"Indexes"=>;
    ...
    ,"public.Association"=>{"Fields"=>;
        ...
        ,"UID"              =>{"Type"=>"C","Length"=>36};   //Used to create direct link, Is a UUID generated by calling postgresql "select gen_random_uuid()".
    ...
    ,"public.Column"=>{"Fields"=>;
        ...
        ,"UID"                     =>{"Type"=>"C","Length"=>36,"Default"=>"gen_random_uuid()::char(36)"};   //Used to create direct link, if the name is not URL friendly, Is a UUID generated by calling Postgresql "select gen_random_uuid()".
        ,"StaticUID"               =>{"Type"=>"C","Length"=>36,"Default"=>"gen_random_uuid()::char(36)"};   //Will be remember between imports/exports, and optionally used to name Foreign Key constraints and Foreign Key Indexes.
        ,"Name"                    =>{"Type"=>"CV","Length"=>200};
        ,"TrackNameChanges"        =>{"Type"=>"L","Default"=>"Wharf-True"};
        ...
        ,"UsedBy"                  =>{"Type"=>"N","Length"=>1,"Default"=>"1"};   //1="AllServers", 2="MySQLOnly", 4="OracleOnly", 3="PostgreSQLOnly"   To restrict the existence of the column to a particular type of backend server.
        ,"UseStatus"               =>{"Type"=>"N","Length"=>1,"Default"=>"1"};   //1="Unknown", 2="Proposed", 3="UnderDevelopment", 4="Active", 5="ToBeDiscontinued", 6="Discontinued"   
        ,"DocStatus"               =>{"Type"=>"N","Length"=>1,"Default"=>"1"};   //1="Missing", 2="NotNeeded", 3="Composing", 4="Complete"   
        ...
        ,"ExternalId"              =>{"Type"=>"I","Nullable"=>.t.};   //Used if syncing with a 3rd party dictionary and via DataWharf API calls.
        ...
        ,"LastNativeTypeMySQL"     =>{"Type"=>"M","Nullable"=>.t.};   //Set during the last "Load Schema". This is the native column type provided by the MySQL/MariaDB backend server.
        ,"LastNativeTypePostgreSQL"=>{"Type"=>"M","Nullable"=>.t.};   //Set during the last "Load Schema". This is the native column type provided by the PostgreSQL backend server.
        ,"LastNativeTypeMSSQL"     =>{"Type"=>"M","Nullable"=>.t.};   //Set during the last "Load Schema". This is the native column type provided by the MSSQL backend server.
        ,"LastNativeTypeOracle"    =>{"Type"=>"M","Nullable"=>.t.}};   //Set during the last "Load Schema". This is the native column type provided by the Oracle backend server.
                      ,"Indexes"=>;
    ...
    ,"public.ColumnPreviousName"=>{"Fields"=>;
        {"pk"       =>{"UsedAs"=>"Primary","Type"=>"I","Default"=>"Wharf-AutoIncrement()","AutoIncrement"=>.t.};
        ,"sysc"     =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Creation Time
        ,"sysm"     =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Last modified time
        ...
        ,"Name"     =>{"Type"=>"CV","Length"=>200,"Nullable"=>.t.}};   //Previous name
                                  ,"Indexes"=>;
    ...
    ,"public.Deployment"=>{"Fields"=>;
        ...
        ,"BackendType"       =>{"Type"=>"N","Length"=>1,"Nullable"=>.t.};   //1="MariaDB", 2="MySQL", 3="PostgreSQL", 4="MSSQL", 5="Oracle"   Connection Info Backend Type.
        ...
        ,"AllowUpdates"      =>{"Type"=>"L","Default"=>"Wharf-False"}};   //If the "Update" option can be executed under the "Deployment Tools".
                          ,"Indexes"=>;
    ...
    ,"public.Entity"=>{"Fields"=>;
        ...
        ,"UID"        =>{"Type"=>"C","Length"=>36};   //Used to create direct link, Is a UUID generated by calling postgresql "select gen_random_uuid()".
        ,"Name"       =>{"Type"=>"CV","Length"=>200};
        ,"Description"=>{"Type"=>"M","Nullable"=>.t.,"AKA"=>"Definition"};   //AKA Definition.
    ...
    ,"public.Enumeration"=>{"Fields"=>;
        ...
        ,"sysc"            =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"sysm"            =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"sysr"            =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Non normalize last modified time of child record.
    ...
    ,"public.EnumValue"=>{"Fields"=>;
        ...
        ,"Code"            =>{"Type"=>"CV","Length"=>10,"Nullable"=>.t.};   //Optional and can be used for reporting. Must be unique.
        ,"Description"     =>{"Type"=>"M","Nullable"=>.t.};
        ,"UseStatus"       =>{"Type"=>"N","Length"=>1,"Default"=>"1"};   //1="Unknown", 2="Proposed", 3="UnderDevelopment", 4="Active", 5="ToBeDiscontinued", 6="Discontinued"   
        ,"DocStatus"       =>{"Type"=>"N","Length"=>1,"Default"=>"1"};   //1="Missing", 2="NotNeeded", 3="Composing", 4="Complete"   
        ,"TestWarning"     =>{"Type"=>"M","Nullable"=>.t.};   //Last Test Run warning messages.
    ...
    ,"public.FastCGIError"=>{"Fields"=>;
        {"pk"          =>{"UsedAs"=>"Primary","Type"=>"I","Default"=>"Wharf-AutoIncrement()","AutoIncrement"=>.t.};
        ,"sysc"        =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Creation Time
        ,"sysm"        =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Last modified time
        ,"sha256"      =>{"Type"=>"B","Length"=>32,"Nullable"=>.t.};   //The Sha-256 of the text of ErrorMessage.
        ,"ErrorMessage"=>{"Type"=>"M","Nullable"=>.t.}};   //Full length error message.
                            ,"Indexes"=>;
        {"sha256"=>{"Expression"=>"sha256","StaticUID"=>"b2d5ddcd-52a6-46d4-9f93-ba2961f91281"}}};
    ,"public.FastCGIRunLog"=>{"Fields"=>;
        {"pk"                  =>{"UsedAs"=>"Primary","Type"=>"I","Default"=>"Wharf-AutoIncrement()","AutoIncrement"=>.t.};
        ,"sysc"                =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"sysm"                =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"fk_FastCGIError"     =>{"UsedAs"=>"Foreign","ParentTable"=>"public.FastCGIError","ForeignKeyOptional"=>.t.,"StaticUID"=>"0dfabb1d-ba51-4458-9789-4dbf5ddc2277","Type"=>"I","Nullable"=>.t.,"OnDelete"=>"Protect"};   //Error Info on Crash.
        ,"fk_User"             =>{"UsedAs"=>"Foreign","ParentTable"=>"public.User","ForeignKeyOptional"=>.t.,"StaticUID"=>"eedd5cfa-af46-4bbb-a39d-456cc0de5a54","Type"=>"I","Nullable"=>.t.,"OnDelete"=>"BreakLink"};   //Set when an error ended the execution of the FastCGI exe.
        ,"UID"                 =>{"Type"=>"C","Length"=>36,"Default"=>"gen_random_uuid()::char(36)","Nullable"=>.t.};
        ,"Datetime"            =>{"Type"=>"DTZ","Scale"=>6};   //First Request time.
        ,"RequestCount"        =>{"Type"=>"I"};
        ,"ErrorDatetime"       =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Time when error occurred.
        ,"ApplicationVersion"  =>{"Type"=>"CV","Length"=>100,"Nullable"=>.t.};
        ,"ApplicationBuildInfo"=>{"Type"=>"CV","Length"=>100,"Nullable"=>.t.};
        ,"IP"                  =>{"Type"=>"CV","Length"=>36};   //In case using IP6.
        ,"OSInfo"              =>{"Type"=>"M","Nullable"=>.t.};
        ,"HostInfo"            =>{"Type"=>"M","Nullable"=>.t.}};
                             ,"Indexes"=>;
        {"fk_fastcgierror"=>{"Expression"=>"fk_FastCGIError","ForForeignKey"=>.t.,"StaticUID"=>"0dfabb1d-ba51-4458-9789-4dbf5ddc2277"};
        ,"fk_user"        =>{"Expression"=>"fk_User","ForForeignKey"=>.t.,"StaticUID"=>"eedd5cfa-af46-4bbb-a39d-456cc0de5a54"}}};
    ,"public.Index"=>{"Fields"=>;
        {"pk"         =>{"UsedAs"=>"Primary","Type"=>"I","Default"=>"Wharf-AutoIncrement()","AutoIncrement"=>.t.};
        ,"sysc"       =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"sysm"       =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ...
        ,"UsedBy"     =>{"Type"=>"N","Length"=>1};   //1="AllServers", 2="MySQLOnly", 4="OracleOnly", 3="PostgreSQLOnly"   
        ,"UseStatus"  =>{"Type"=>"N","Length"=>1,"Default"=>"1"};   //1="Unknown", 2="Proposed", 3="UnderDevelopment", 4="Active", 5="ToBeDiscontinued", 6="Discontinued"   
        ,"DocStatus"  =>{"Type"=>"N","Length"=>1,"Default"=>"1"};   //1="Missing", 2="NotNeeded", 3="Composing", 4="Complete"   
        ,"TestWarning"=>{"Type"=>"M","Nullable"=>.t.};   //Last Test Run warning messages.
        ,"StaticUID"  =>{"Type"=>"C","Length"=>36,"Default"=>"gen_random_uuid()::char(36)"}};   //Will be remember between imports/exports, and optionally used to name Indexes as "dw_"+StaticUID+"_idx"
                     ,"Indexes"=>;
    ...
    ,"public.LoginLogs"=>{"Fields"=>;
        ...
        ,"fk_WebUserAgent"=>{"UsedAs"=>"Foreign","ParentTable"=>"public.WebUserAgent","ForeignKeyOptional"=>.t.,"StaticUID"=>"46af0e5d-dfa8-48b2-91fa-e642f0ba7752","Type"=>"I","Nullable"=>.t.,"OnDelete"=>"Protect"};   //Marked as Optional to deal with previous records.
        ,"TimeIn"         =>{"Type"=>"DTZ","Scale"=>2};
        ,"TimeOut"        =>{"Type"=>"DTZ","Scale"=>2,"Nullable"=>.t.};
        ...
        ,"fk_webuseragent"=>{"Expression"=>"fk_WebUserAgent","ForForeignKey"=>.t.,"StaticUID"=>"46af0e5d-dfa8-48b2-91fa-e642f0ba7752"}}};
    ,"public.Model"=>{"Fields"=>;
        {"pk"         =>{"UsedAs"=>"Primary","Type"=>"I","Default"=>"Wharf-AutoIncrement()","AutoIncrement"=>.t.};
        ,"sysc"       =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"sysm"       =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
    ...
    ,"public.Tag"=>{"Fields"=>;
        ...
        ,"UID"            =>{"Type"=>"C","Length"=>36,"Default"=>"gen_random_uuid()::char(36)"};
        ,"Code"           =>{"Type"=>"CV","Length"=>10};
    ...
    ,"public.TimeZone"=>{"Fields"=>;
        {"pk"                =>{"UsedAs"=>"Primary","Type"=>"I","Default"=>"Wharf-AutoIncrement()","AutoIncrement"=>.t.};
        ,"sysc"              =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Creation Time
        ,"sysm"              =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Last modified time
        ,"Name"              =>{"Type"=>"CV","Length"=>100};
        ,"Abbreviation"      =>{"Type"=>"CV","Length"=>10};
        ,"UTCOffset"         =>{"Type"=>"I"};
        ,"DaylightSavingTime"=>{"Type"=>"L"};
        ,"Status"            =>{"Type"=>"N","Length"=>1,"Default"=>"1"}};   //1="Active", 2="NotToBeUsed", 3="Discontinued"   
                        };
    ,"public.User"=>{"Fields"=>;
        {"pk"                             =>{"UsedAs"=>"Primary","Type"=>"I","Default"=>"Wharf-AutoIncrement()","AutoIncrement"=>.t.};
        ,"sysc"                           =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"sysm"                           =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};
        ,"fk_TimeZone"                    =>{"UsedAs"=>"Foreign","ParentTable"=>"public.TimeZone","ForeignKeyOptional"=>.t.,"StaticUID"=>"d9abd4bf-a0ba-47db-bc5d-24923f7e90de","Type"=>"I","Nullable"=>.t.,"OnDelete"=>"BreakLink"};   //User's Time Zone to use when displaying date/times.
        ...
        ,"Status"                         =>{"Type"=>"N","Length"=>1};   //1="Active", 2="Inactive"   
        ,"Description"                    =>{"Type"=>"M","Nullable"=>.t.};
        ,"ErrorExplorerLastReviewDatetime"=>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.}};   //Timestamp to filter out previous errors listed in "Error Explorer".
                    ,"Indexes"=>;
        {"fk_timezone"=>{"Expression"=>"fk_TimeZone","ForForeignKey"=>.t.,"StaticUID"=>"d9abd4bf-a0ba-47db-bc5d-24923f7e90de"}}};
    ...
    ,"public.WebUserAgent"=>{"Fields"=>;
        {"pk"       =>{"UsedAs"=>"Primary","Type"=>"I","Default"=>"Wharf-AutoIncrement()","AutoIncrement"=>.t.};
        ,"sysc"     =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Creation Time
        ,"sysm"     =>{"Type"=>"DTZ","Scale"=>6,"Nullable"=>.t.};   //Last modified time
        ,"sha256"   =>{"Type"=>"B","Length"=>32};   //The Sha-256 of the text of AgentInfo.
        ,"AgentInfo"=>{"Type"=>"M"}};   //Full length of Agent Info.  The value of "HTTP_USER_AGENT" in FastCGI.
                            ,"Indexes"=>;
        {"sha256"=>{"Expression"=>"sha256","StaticUID"=>"adc7ac90-39d5-4262-b17e-378809db219d"}}};
...
"Enumerations"=>;
    ...
    ,"public.SupportColumnsDateTimeConfig"=>{;
        "ImplementAs"=>"Numeric",;
        "ImplementLength"=>1,;
        "Values"=>;
            {"NoChange"       =>{"Order"=>1,"Number"=>1};
            ,"WithoutTimeZone"=>{"Order"=>2,"Number"=>2};
            ,"WithTimeZone"   =>{"Order"=>3,"Number"=>3}}};
    ,"public.TagUseStatus"=>{;
        "ImplementAs"=>"Numeric",;
        "ImplementLength"=>1,;
        "Values"=>;
    ...
    ,"public.TimeZoneStatus"=>{;
        "ImplementAs"=>"Numeric",;
        "ImplementLength"=>1,;
        "Values"=>;
            {"Active"      =>{"Order"=>1,"Number"=>1};
            ,"NotToBeUsed" =>{"Order"=>2,"Number"=>2};
            ,"Discontinued"=>{"Order"=>3,"Number"=>3}}};
    ,"public.UsedBy"=>{;
        "ImplementAs"=>"Numeric",;
        "ImplementLength"=>1,;
        "Values"=>;
            ...
            ,"OracleOnly"    =>{"Order"=>3,"Number"=>4};
            ,"PostgreSQLOnly"=>{"Order"=>4,"Number"=>3}}};
