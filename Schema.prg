...
,"public.UserAccessApplication"=>{;   //Field Definition
   ...
   ,"fk_User"        =>{,  "I",   0,  0,};
   ,"fk_Application" =>{,  "I",   0,  0,};
   ,"AccessLevelDD"  =>{,  "N",   1,  0,}};      // Data Dictionary Access Level: 1 - None,2 - Read Only,3 - Edit Description and Information Entries,4 - Edit Description and Information Entries and Diagrams,5 - Edit Anything and Import/Export,6 - Edit Anything and Load/Sync Schema,7 - Full Access
   ,;   //Index Definition
...
,"public.UserSettingApplication"=>{;   //Field Definition
   ...
   ,"fk_User"        =>{,  "I",   0,  0,};
   ,"fk_Application" =>{,  "I",   0,  0,};
   ,"fk_Diagram"     =>{,  "I",   0,  0,}};      //  Last Accessed Diagram, to help default the menu to restart on that diagram.
   ,;   //Index Definition
   {"fk_User"       =>{,"fk_User"       ,.f.,"BTREE"};
   ,"fk_Application"=>{,"fk_Application",.f.,"BTREE"};
   ,"fk_Diagram"    =>{,"fk_Diagram"    ,.f.,"BTREE"}}};
